 ...
 *  * 
 * GET / {token: <adminToken> }=> { users: [ {username, firstName, lastName, email }, ... ] }
 *
 ...
 * GET /[username] {token: <adminToken> }=> { username, first_name, last_name, email, image_url, last_logged}
...
/** Update user data
 *  
 * PATCH /[username] {data:{ <user> }, token: <adminToken> } => { username, firstName, lastName, email, image_url, last_logged}
 *
 * Data can include:
...
/** Set User as Admin
 *  
 * PATCH /[username] {data:{ is_admin:true }, token: <adminToken> } => { username, firstName, lastName, email, image_url, last_logged, is_admin}
 *
...
router.patch("/:username/setAdmin", ensureIsAdmin, async function (req, res, next) {
  try {
